...
#' @param size rectangular dimensions of map in pixels - horizontal x vertical - with a max of c(640, 640).
#' @param format character string providing image format - png, jpeg(jpg) formats available in various flavors
...
#' @param overlayers overlay layers, this can be "anno_satellite","bicycle", "roadview", "traffic".
#' @param markers data.frame with first column longitude, second column latitude, for which naver markers should be embedded in the map image, or character string to be passed directly to api
...
#' @param archiving use archived maps.  note: by changing to TRUE you agree to abide by any of the rules governing caching naver maps
#' @param ... ...
